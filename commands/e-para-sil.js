...
module.exports = {
    name:"para-sil",
    description: 'Birinin hesabından para alırsın!',
    type:1,
    options: [
      {
        name:"user",
        description:"Kimden alıcaksın?",
        type:6,
        required:true
    },
    {
        name:"miktar",
        description:"Ne kadar alıcaksın?",
        type:3,
        required:true
    },
  ...
  run: async(client, message) => {
    ...
    .setDescription(`Para Alan: ${message.user}\nMiktar: **${miktar}**\nParası Giden: ${kullanıcı}`)
    .setColor("DarkRed")
